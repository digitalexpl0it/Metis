...
| Proton game: cursor jumps on left/right click while aiming | Fixed 2026-07-18 (stale hint invalidated on mouse-look; lock anchor restored; no absolute click warp over games; game windows skip pointer-motion throttle). Rebuild/reinstall compositor and re-login |
