...
if [[ $# -lt 1 ]]; then
    echo "Usage: metis-cmd.sh {close-popovers|reload-bar|reload-theme|reload-weather|reload-calendars|reload-gaming|optimize-gaming|show-onboarding|settings [page]}" >&2
