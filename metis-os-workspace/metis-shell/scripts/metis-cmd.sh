...
if [[ $# -lt 1 ]]; then
    echo "Usage: metis-cmd.sh {close-popovers|reload-bar|reload-dashboard|reload-theme|reload-weather|reload-calendars|reload-gaming|optimize-gaming|show-onboarding|screenshot|settings [page]}" >&2
